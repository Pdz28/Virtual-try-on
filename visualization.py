...
def save_images(img_tensors, img_names, save_dir):
    ...
    for img_tensor, img_name in zip(img_tensors, img_names):
        ...
        if tensor.shape[0] == 1:
            ...
            array = tensor.permute(1, 2, 0).detach().numpy().astype('uint8')
        
        # Lưu file trực tiếp vào thư mục save_dir với tên img_name
        # Không tạo thêm thư mục con với tên img_name
